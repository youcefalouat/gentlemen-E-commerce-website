            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="wilaya" class="col-md-4 col-form-label text-md-end">Selectionner une Wilaya:</label>
                        ...
                        <div class="row mb-3">
                            <label for="commune" class="col-md-4 col-form-label text-md-end">Selectionner une commune:</label>
